...
\newtheoremstyle{proofstyle}% name of the style to be used
  ...
  {0pt}% measure of space to indent
  {\bfseries}% name of head font
  {\textcolor{brown}:}% punctuation between head and body
  { }% space after theorem head; " " = normal interword space
  {
    \textcolor{brown}
    {\thmname{#1}}
...
\newenvironment{proofe}{
  \vspace{-0.59cm}
  \begin{tcolorbox}[frame hidden, boxrule=0pt,borderline west={2pt}{0pt}{brown},
...
\newenvironment{proofr}{
  \vspace{-0.59cm}
  \begin{tcolorbox}[frame hidden, boxrule=0pt,borderline west={2pt}{0pt}{brown},
    borderline west={2pt}{5mm}{black}, colback=brown!10!white, left=10mm
    ]{}
}{
\end{tcolorbox}
}
...
\newenvironment{proofrr}{
  \vspace{-0.59cm}
  \begin{tcolorbox}[frame hidden, boxrule=0pt,borderline west={2pt}{0pt}{brown},
    borderline west={1pt}{10mm}{black!80!white}, borderline west={2pt}{5mm}{black}, colback=brown!10!white, left=15mm
    ]{}
}{
\end{tcolorbox}
}
...
\newenvironment{proposition}[1]{
  \begin{tcolorbox}[frame hidden, boxrule=0pt ,
    borderline west={2pt}{0pt}{orange!92!black}, colback=orange!10!white]{}
...
\newenvironment{corollary}[1]{
  \begin{tcolorbox}[frame hidden, boxrule=0pt ,
    borderline west={2pt}{0pt}{cyan}, colback=cyan!8!white]{}
...
\newenvironment{definition}[1]{
  \begin{tcolorbox}[frame hidden, boxrule=0pt ,
    borderline west={2pt}{0pt}{green!70!black}, colback=green!8!white]{}
...
\newenvironment{example}{
  \begin{tcolorbox}[frame hidden, boxrule=0pt ,
    borderline west={2pt}{0pt}{blue!80!white}, colback=blue!10!white]{}
    \begin{exampleenv}{}
  }{
  \end{exampleenv}
\end{tcolorbox}
...
\newtheoremstyle{applicationstyle}% name of the style to be used
  {\topsep}% measure of space to leave above the application. E.g.: 3pt
  {\topsep}% measure of space to leave below the application. E.g.: 3pt
  {\itshape}% name of font to use in the body of the application
  {0pt}% measure of space to indent
  {\bfseries}% name of head font
  {}% punctuation between head and body
  { }% space after application head; " " = normal interword space
  {
    \textcolor{cyan}
    {\thmname{#1} \thmnumber{#2}{\thmnote{#3}}}
  }

\theoremstyle{applicationstyle}
